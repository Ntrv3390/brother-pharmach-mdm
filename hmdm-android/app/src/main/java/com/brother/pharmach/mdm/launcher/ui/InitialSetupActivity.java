...
import com.brother.pharmach.mdm.launcher.databinding.ActivityInitialSetupBinding;
import com.brother.pharmach.mdm.launcher.helper.CertInstaller;
...
public class InitialSetupActivity extends BaseActivity implements ConfigUpdater.UINotifier, CertInstaller.Listener {
    ...
    public void onConfigLoaded() {
        // Set Brother Pharmamach MDM as the default launcher if required
        ...
        if (config != null) {
            ...
            if (Utils.isDeviceOwner(this) &&
                ...
                // Brother Pharmamach MDM works with default system launcher
                // Run services here
