...
public class Const {
    ...
    public static final String LAUNCHER_RESTARTER_PACKAGE_ID = "com.brother.pharmach.mdm.emuilauncherrestarter";
    ...
    public static final String KIOSK_BROWSER_PACKAGE_NAME = "com.brother.pharmach.mdm.kiosk";
    public static final String APUPPET_PACKAGE_NAME = "com.brother.pharmach.mdm.control";
    public static final String APUPPET_SERVICE_CLASS_NAME = "com.brother.pharmach.mdm.control.GestureDispatchService";

    public static final String QR_BASE_URL_ATTR = "com.brother.pharmach.mdm.BASE_URL";
    public static final String QR_SECONDARY_BASE_URL_ATTR = "com.brother.pharmach.mdm.SECONDARY_BASE_URL";
    public static final String QR_SERVER_PROJECT_ATTR = "com.brother.pharmach.mdm.SERVER_PROJECT";
    public static final String QR_DEVICE_ID_ATTR = "com.brother.pharmach.mdm.DEVICE_ID";
    public static final String QR_LEGACY_DEVICE_ID_ATTR = "ru.headwind.kiosk.DEVICE_ID";
    public static final String QR_DEVICE_ID_USE_ATTR = "com.brother.pharmach.mdm.DEVICE_ID_USE";
    public static final String QR_CUSTOMER_ATTR = "com.brother.pharmach.mdm.CUSTOMER";
    public static final String QR_CONFIG_ATTR = "com.brother.pharmach.mdm.CONFIG";
    public static final String QR_GROUP_ATTR = "com.brother.pharmach.mdm.GROUP";
    public static final String QR_OPEN_WIFI_ATTR = "com.brother.pharmach.mdm.OPEN_WIFI";
    public static final String QR_WORK_PROFILE_ATTR = "com.brother.pharmach.mdm.WORK_PROFILE";
    public static final String QR_CERTS_ATTR = "com.brother.pharmach.mdm.CERTS";
    public static final int KIOSK_UNLOCK_CLICK_COUNT = 4;

    public static final String INTENT_PUSH_NOTIFICATION_PREFIX = "com.brother.pharmach.mdm.push.";
    public static final String INTENT_PUSH_NOTIFICATION_EXTRA = "com.brother.pharmach.mdm.PUSH_DATA";

    public static final String WORK_TAG_COMMON = "com.brother.pharmach.mdm.launcher";
