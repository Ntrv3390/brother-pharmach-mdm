...
import com.brother.pharmach.mdm.launcher.db.DownloadTable;
import com.brother.pharmach.mdm.launcher.db.RemoteFileTable;
...
import com.brother.pharmach.mdm.launcher.task.ConfirmDeviceResetTask;
import com.brother.pharmach.mdm.launcher.task.ConfirmPasswordResetTask;
import com.brother.pharmach.mdm.launcher.task.ConfirmRebootTask;
import com.brother.pharmach.mdm.launcher.task.GetRemoteLogConfigTask;
...
public class ConfigUpdater {
    ...
    private void applyUninstallProtection() {
        ...
        ComponentName adminComponentName = com.brother.pharmach.mdm.launcher.util.LegacyUtils.getAdminComponentName(context);
