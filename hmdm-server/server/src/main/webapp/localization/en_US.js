...
document.localization["en_US"] = {
  ...
  "success.backup.email.saved": "Backup email saved successfully",
  "success.backup.email.sent": "Backup emailed to",
  "error.backup.email.invalid": "Please enter a valid email address",
  "error.backup.email.failed": "Failed to send backup email. Check server logs.",
  "error.backup.smtp.notconfigured": "SMTP is not configured on this server, so the backup could not be emailed.",
  ...
  "app.vendor.name": "Brother Pharmamach MDM",
  "app.vendor.link": "",
